...
The [sync-sepolia.yaml](./sync-sepolia.yaml) is already configured so the consensus client can connect to it. Go in the folder where this readme is contained (so [here](.)) and run:
