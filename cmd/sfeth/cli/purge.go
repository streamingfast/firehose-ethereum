...
var purgeCmd = &cobra.Command{Use: "purge", Short: "Purgeslocal data", RunE: sfPurgeE}
...
func sfPurgeE(cmd *cobra.Command, args []string) error {
	...
	userLog.Printf("Purged data. Start a fresh instance with 'sfeth start'")
