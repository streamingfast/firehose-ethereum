...
require (
	...
	github.com/streamingfast/firehose v0.1.1-0.20230221145342-8772b901f591
	github.com/streamingfast/firehose-ethereum/types v0.0.0-20230301124208-8d73ea37b7ca
