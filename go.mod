...
require (
	...
	github.com/streamingfast/sf-ethereum/types v0.0.0-20220428193312-d3887d214eef
	...
	github.com/streamingfast/substreams v0.0.5-beta.0.20220429145722-99f3cdacb08c
