...
require (
	...
	github.com/streamingfast/sf-ethereum/types v0.0.0-20220725201109-ffc117dd8a47
	...
	github.com/streamingfast/substreams v0.0.14-0.20220726131614-7a093ee66a54
