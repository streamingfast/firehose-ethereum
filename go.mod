...
require (
	...
	github.com/streamingfast/sf-ethereum/types v0.0.0-20220722210119-d12a2fd05565
	...
	github.com/streamingfast/substreams v0.0.14-0.20220725184923-e2af2b45f04a
