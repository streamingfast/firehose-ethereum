...
require (
	...
	github.com/streamingfast/firehose-core v1.4.2-0.20240514235211-75636557dda2
	github.com/streamingfast/firehose-ethereum/types v0.0.0-20240419152810-415efff8efec
