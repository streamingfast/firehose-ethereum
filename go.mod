...
require (
	...
	github.com/streamingfast/substreams v0.0.22-0.20221103202956-042000d9b0ec
...
require (
	...
	github.com/streamingfast/sf-tracing v0.0.0-20221103192900-b0236ce6865a // indirect
