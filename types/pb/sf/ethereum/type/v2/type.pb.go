...
type TransactionTrace struct {
	...
	// BlobGas is the amount of gas the transaction is going to pay for the blob, this is a computed value
	// based using `self.blob_gas_fee_cap * len(self.blob_hashes)`.
	//
