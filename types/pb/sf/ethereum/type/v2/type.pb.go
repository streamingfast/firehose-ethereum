...
type BlockHeader struct {
	...
	//	  excess_data_gas (to be included only if Dencun fork is active)
	//	]))
	...
	// ExcesseDataGas is the running total of excess data gas consumed on chain since EIP-4844 (Shared Blob Transactions) was activated.
	// If the total amount of data gas is below the target, 'excess_data_gas' is capped at zero.
	ExcessDataGas *BigInt `protobuf:"bytes,21,opt,name=excess_data_gas,json=excessDataGas,proto3" json:"excess_data_gas,omitempty"`
}
...
func (x *BlockHeader) GetExcessDataGas() *BigInt {
	if x != nil {
...
type TransactionTrace struct {
	...
	// BlockDataGasUSed keep track of total data gas spent in this transaction, it's sum up for all successful
	// transaction in a block and can be used to compute the block's data gas. The data gas is computed using
	// the formula `BlobTxDataGasPerBlob * len(BlobVersionedHashes)` where is `BlobTxDataGasPerBlob` is decided
	// by the current Ethereum active fork (at time of introduction of the Blob feature, this value was 17).
	//
	// It means the gas per blob can be computed by doing `blob_data_gas_used/len(BlobVersionedHashes`.
	//
	...
	// if Dencun fork is active on the chain.
	BlobDataGasUsed uint64 `protobuf:"varint,33,opt,name=blob_data_gas_used,json=blobDataGasUsed,proto3" json:"blob_data_gas_used,omitempty"`
	// MaxFeePerDataGas is the maximum fee per data gas the user is willing to pay for the data gas used.
	//
	// This is specified by https://eips.ethereum.org/EIPS/eip-4844
	//
	// This will is populated only if `TransactionTrace.Type == TRX_TYPE_BLOB` which is possible only
	// if Dencun fork is active on the chain.
	MaxFeePerDataGas *BigInt `protobuf:"bytes,34,opt,name=max_fee_per_data_gas,json=maxFeePerDataGas,proto3" json:"max_fee_per_data_gas,omitempty"`
	// BlobVersionedHashes field represents a list of hash outputs from 'kzg_to_versioned_hash' which
	...
	// This will is populated only if `TransactionTrace.Type == TRX_TYPE_BLOB` which is possible only
	// if Dencun fork is active on the chain.
	BlobVersionedHashes [][]byte `protobuf:"bytes,35,rep,name=blob_versioned_hashes,json=blobVersionedHashes,proto3" json:"blob_versioned_hashes,omitempty"`
}
...
func (x *TransactionTrace) GetBlobDataGasUsed() uint64 {
	if x != nil {
		return x.BlobDataGasUsed
	}
	return 0
}

func (x *TransactionTrace) GetMaxFeePerDataGas() *BigInt {
	if x != nil {
		return x.MaxFeePerDataGas
	}
	return nil
}

func (x *TransactionTrace) GetBlobVersionedHashes() [][]byte {
	if x != nil {
...
var file_sf_ethereum_type_v2_type_proto_rawDesc = []byte{
	...
	0x29, 0x10, 0x2a, 0x4a, 0x04, 0x08, 0x2a, 0x10, 0x2b, 0x22, 0xed, 0x06, 0x0a, 0x0b, 0x42, 0x6c,
	...
	,
	...
	0x74, 0x65, 0x73, 0x22, 0xab, 0x0b, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	...
	,
	...
	0x73, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x42, 0x0a, 0x0f, 0x6d, 0x61, 0x78, 0x5f, 0x66, 0x65,
	...
	,
	...
	0x6c, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x65, 0x6e, 0x64, 0x4f, 0x72, 0x64, 0x69,
	0x6e, 0x61, 0x6c, 0x12, 0x43, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x1e, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x73, 0x66, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x41, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x65,
	0x69, 0x70, 0x74, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x66, 0x2e, 0x65,
	...
	,
...
var file_sf_ethereum_type_v2_type_proto_depIdxs = []int32{
	...
	10, // 11: sf.ethereum.type.v2.BlockHeader.excess_data_gas:type_name -> sf.ethereum.type.v2.BigInt
	...
	10, // 22: sf.ethereum.type.v2.TransactionTrace.max_fee_per_data_gas:type_name -> sf.ethereum.type.v2.BigInt
	14, // 23: sf.ethereum.type.v2.TransactionReceipt.logs:type_name -> sf.ethereum.type.v2.Log
	1,  // 24: sf.ethereum.type.v2.Call.call_type:type_name -> sf.ethereum.type.v2.CallType
	10, // 25: sf.ethereum.type.v2.Call.value:type_name -> sf.ethereum.type.v2.BigInt
	27, // 26: sf.ethereum.type.v2.Call.keccak_preimages:type_name -> sf.ethereum.type.v2.Call.KeccakPreimagesEntry
	16, // 27: sf.ethereum.type.v2.Call.storage_changes:type_name -> sf.ethereum.type.v2.StorageChange
	17, // 28: sf.ethereum.type.v2.Call.balance_changes:type_name -> sf.ethereum.type.v2.BalanceChange
	18, // 29: sf.ethereum.type.v2.Call.nonce_changes:type_name -> sf.ethereum.type.v2.NonceChange
	14, // 30: sf.ethereum.type.v2.Call.logs:type_name -> sf.ethereum.type.v2.Log
	20, // 31: sf.ethereum.type.v2.Call.code_changes:type_name -> sf.ethereum.type.v2.CodeChange
	21, // 32: sf.ethereum.type.v2.Call.gas_changes:type_name -> sf.ethereum.type.v2.GasChange
	19, // 33: sf.ethereum.type.v2.Call.account_creations:type_name -> sf.ethereum.type.v2.AccountCreation
	10, // 34: sf.ethereum.type.v2.BalanceChange.old_value:type_name -> sf.ethereum.type.v2.BigInt
	10, // 35: sf.ethereum.type.v2.BalanceChange.new_value:type_name -> sf.ethereum.type.v2.BigInt
	4,  // 36: sf.ethereum.type.v2.BalanceChange.reason:type_name -> sf.ethereum.type.v2.BalanceChange.Reason
	5,  // 37: sf.ethereum.type.v2.GasChange.reason:type_name -> sf.ethereum.type.v2.GasChange.Reason
	7,  // 38: sf.ethereum.type.v2.HeaderOnlyBlock.header:type_name -> sf.ethereum.type.v2.BlockHeader
	6,  // 39: sf.ethereum.type.v2.BlockWithRefs.block:type_name -> sf.ethereum.type.v2.Block
	25, // 40: sf.ethereum.type.v2.BlockWithRefs.transaction_trace_refs:type_name -> sf.ethereum.type.v2.TransactionRefs
	11, // 41: sf.ethereum.type.v2.TransactionTraceWithBlockRef.trace:type_name -> sf.ethereum.type.v2.TransactionTrace
	26, // 42: sf.ethereum.type.v2.TransactionTraceWithBlockRef.block_ref:type_name -> sf.ethereum.type.v2.BlockRef
