...
type TransactionState struct {
	...
	BlockHeader       *v1.BlockHeader             `protobuf:"bytes,4,opt,name=block_header,json=blockHeader,proto3" json:"block_header,omitempty"`
	TransactionTraces *v1.TransactionTrace        `protobuf:"bytes,5,opt,name=transaction_traces,json=transactionTraces,proto3" json:"transaction_traces,omitempty"`
	Confirmation      uint64                      `protobuf:"varint,6,opt,name=confirmation,proto3" json:"confirmation,omitempty"`
	HeadBlockHeader   *v1.BlockHeader             `protobuf:"bytes,7,opt,name=head_block_header,json=headBlockHeader,proto3" json:"head_block_header,omitempty"`
...
func (x *TransactionState) GetBlockHeader() *v1.BlockHeader {
	if x != nil {
...
func (x *TransactionState) GetTransactionTraces() *v1.TransactionTrace {
	if x != nil {
...
func (x *TransactionState) GetHeadBlockHeader() *v1.BlockHeader {
	if x != nil {
...
type Transaction struct {
	...
	GasPrice *v1.BigInt `protobuf:"bytes,3,opt,name=gas_price,json=gasPrice,proto3" json:"gas_price,omitempty"`
	GasLimit uint64     `protobuf:"varint,4,opt,name=gas_limit,json=gasLimit,proto3" json:"gas_limit,omitempty"`
	Value    *v1.BigInt `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"` // amount of ETH transfered, in addition to used_gas * gas_price, sometimes referred to as `Amount`
...
func (x *Transaction) GetGasPrice() *v1.BigInt {
	if x != nil {
		return x.GasPrice
	}
	return nil
...
func (x *Transaction) GetValue() *v1.BigInt {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_sf_ethereum_trxstream_v1_trxstream_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2e,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x30, 0x01, 0x42, 0x59, 0x5a, 0x57, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x70, 0x72, 0x69, 0x76, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x62, 0x2f, 0x73, 0x66,
	0x2f, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2f, 0x74, 0x72, 0x78, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x2f, 0x76, 0x31, 0x3b, 0x70, 0x62, 0x74, 0x72, 0x78, 0x73, 0x74, 0x72, 0x65,
...
var file_sf_ethereum_trxstream_v1_trxstream_proto_goTypes = []interface{}{
	...
	(*v1.BlockHeader)(nil),           // 5: sf.ethereum.type.v1.BlockHeader
	(*v1.TransactionTrace)(nil),      // 6: sf.ethereum.type.v1.TransactionTrace
	(*timestamppb.Timestamp)(nil),    // 7: google.protobuf.Timestamp
	(*v1.BigInt)(nil),                // 8: sf.ethereum.type.v1.BigInt
}
var file_sf_ethereum_trxstream_v1_trxstream_proto_depIdxs = []int32{
	...
	5,  // 4: sf.ethereum.trxstream.v1.TransactionState.block_header:type_name -> sf.ethereum.type.v1.BlockHeader
	6,  // 5: sf.ethereum.trxstream.v1.TransactionState.transaction_traces:type_name -> sf.ethereum.type.v1.TransactionTrace
	5,  // 6: sf.ethereum.trxstream.v1.TransactionState.head_block_header:type_name -> sf.ethereum.type.v1.BlockHeader
	...
	8,  // 9: sf.ethereum.trxstream.v1.Transaction.gas_price:type_name -> sf.ethereum.type.v1.BigInt
	8,  // 10: sf.ethereum.trxstream.v1.Transaction.value:type_name -> sf.ethereum.type.v1.BigInt
