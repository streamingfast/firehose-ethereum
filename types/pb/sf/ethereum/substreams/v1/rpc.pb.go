...
var file_sf_ethereum_substreams_v1_rpc_proto_rawDesc = []byte{
	...
	0x31, 0x3b, 0x70, 0x62, 0x65, 0x74, 0x68, 0x73, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_sf_ethereum_substreams_v1_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sf_ethereum_substreams_v1_rpc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sf_ethereum_substreams_v1_rpc_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sf_ethereum_substreams_v1_rpc_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sf_ethereum_substreams_v1_rpc_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
