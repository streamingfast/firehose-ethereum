...
func (c *transactionStreamClient) Transactions(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (TransactionStream_TransactionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionStream_ServiceDesc.Streams[0], "/dfuse.ethereum.trxstream.v1.TransactionStream/Transactions", opts...)
	if err != nil {
		return nil, err
	}
...
var TransactionStream_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dfuse.ethereum.trxstream.v1.TransactionStream",
	...
	Metadata: "dfuse/ethereum/trxstream/v1/trxstream.proto",
}
